    ...
    return (
      <div>
        ...
        {this.props.items.map((item, index) => (
          <AnswerNumberTS key={index} item={item} />
        ))}
      </div>
    );
  }
...
class InputTS extends React.Component<
  {
    value: string;
...
class SortFunctionTS extends React.Component<
  any,
  { input: string; answer: number[] }
> {
...
let data = [4, 3, 2, 1];
ReactDOM.render(<SortFunctionTS />, document.getElementById("container_ts"));
